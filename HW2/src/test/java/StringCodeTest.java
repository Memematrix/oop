...
public class StringCodeTest {
    ...
    public void testIntersect_Normal() {
        assertEquals(true, StringCode.stringIntersect("aabb", "aab", 2));
    }
    @Test
    public void testIntersect_Len1() {
        assertEquals(true, StringCode.stringIntersect("aabb", "aab", 1));
    }
    @Test
    public void testIntersect_S1Len1() {
        assertEquals(true, StringCode.stringIntersect("a", "aab", 1));
    }
    @Test
    public void testIntersect_SNone() {
        assertEquals(false, StringCode.stringIntersect("", "", 1));
    }
    @Test
    public void testIntersect_SNoneLen0() {
